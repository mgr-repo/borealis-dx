...
install -Dm0644 /ctx/files/ujust/openshift-client.just /usr/share/ublue-os/just/openshift-client.just
...
install -Dm0755 /ctx/files/scripts/openshift-client-install.sh /usr/share/ublue-os/just/scripts/openshift-client-install.sh